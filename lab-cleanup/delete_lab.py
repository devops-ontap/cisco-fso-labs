...
outfile_instanceids='instids.json'
get_instances='aws ec2 describe-instances --region' + " " + "{}".format(region) + " " + '--filters Name=availability-zone,Values=' + "{}".format(az) + " " + '--query' + " " + '"Reservations[*].Instances[*].InstanceId"' + " " + '--output text'
