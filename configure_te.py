...
#Import the VARS to get the external IP of both ubuntu
#Write a For Each to pass in the var for the external IP
#remove ssh access, is too cumbersome for lab and replace with a username and password from vault.
