...
helm install -f ./values.yaml appdynamics-lab appdynamics-charts/cluster-agent -n appdynamics-lab-2
helm status appdynamics-lab-2 -n default
helm get appdynamics-lab-2 -n default
kubectl get pods -n appdynamics-lab-2
